FactoryGirl.create(:user, email: 'admin@socialrecipes.com',    password: 'adminadmin', admin: true,  first_name: 'Admin',    last_name: 'King',    city: 'Adminland',   facebook: 'facebook.com/admin',      twitter: '@admin',      cuisines: 'None, of, your, business')
...
FactoryGirl.create(:user, email: 'paul@socialrecipes.com',     password: 'useruser',   admin: false, first_name: 'Paul',     last_name: 'Phoenix', city: 'Phoenixland', facebook: 'facebook.com/paul',       twitter: '@pphoenix',   cuisines: 'Indian, German')
FactoryGirl.create(:user, email: 'rosemary@socialrecipes.com', password: 'useruser',   admin: false, first_name: 'Rosemary', last_name: 'Smith',   city: 'Fairyland',   facebook: 'facebook.com/crookedman', twitter: '@crookedman', cuisines: 'Fictional, American, French')
FactoryGirl.create(:user, email: 'laura@socialrecipes.com',    password: 'useruser',   admin: false, first_name: 'Laura',    last_name: 'Spencer', city: 'Austin',      facebook: 'facebook.com/laura',      twitter: '@laura',      cuisines: 'American, Brazilian, French')
